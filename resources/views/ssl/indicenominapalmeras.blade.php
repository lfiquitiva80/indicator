<!DOCTYPE html>
	...
	<form autocomplete='off' action="" method="{{route('indicessl')}}" name="RVH"> 
		<table style="width: 50%" class="table table-bordered">
			<tr align="center">
				<td bgcolor="#C3EE6D" colspan="2"><strong>INDICADORES COSTOS SSL Vs EMPLEADOS</strong></td>
			</tr> 
			<tr>
			...
			<tr>
				<td>   
					<center> 
						<select class='form-control' style='width: 80%' name='Tipo' required onchange="cambiar(this.value)">
							<option value="#">Seleccione un tipo de indicador</option> 
							<option value="{{ route('seleccionaraniosssl') }}" id="comparativo" >Comparativo por Año</option>
							<option value="02" selected >Costo SSL Vs Empleado Mes / Año</option>
							<option value="03">Acumulado Costo SSL Vs Empleado Mes / Año</option>
							<option value="{{ url('excel/show') }}">Formulario para Descargar Empleados en Excel</option>
			...
			<tr>
				...
				<td align="center" colspan="2"><input type="submit" class="btn btn-warning btn-block" id="boton" value="¡BUSCAR!"/></td> 
			</tr>
		</table> 
	</form>
	<div id="carga">
