...
<div> 
	<div id="wrapperMenu">	             
		<ol class="breadcrumb">
		  <li class="breadcrumb-item"><strong><a class="linkmigas" href="{{ url('indicessl') }}">Indicadores Nómina</a></strong></li> 
...
<!-- 		<tr>
	...
	<table style="width:70%" align="center" class="table table-hover table-striped table-bordered"> 
		<form autocomplete='off' action="" method="{{route('seleccionaraniosssl')}}">
		<tr align="center">
